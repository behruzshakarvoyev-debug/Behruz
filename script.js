...
//   resp.users.forEach((user, index, array) => {
//     usersContainer.innerHTML += `<h1>${user.firstName}</h1>`
//   });
// })
const usersContainer = document.getElementById('Behruz')
...
data.users.forEach((user, index, array)=>{
  usersContainer.innerHTML += `<p>${user.firstName}</p>`
});
